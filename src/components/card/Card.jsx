...
const Card = ({ product }) => {
  ...
  const handleImageError = (event) => {
    event.target.src =
      "https://images.bewakoof.com/t1080/men-s-checks-stylish-casual-evening-trackpant-351563-1656012838-1.jpg";
  };
  // console.log(product);
  return (
    <div className="card-wrapper" onClick={handleImageClick}>
